...
export default function TopNavBar() {
  ...
  return (
    <div className="flex flex-col items-center min-w-fit">
      <div className="w-[1440px] flex justify-between items-center px-4 py-2 ">
        <div>
        ...
        <div className="relative flex-grow bg-brightGreen" style={{ marginLeft: "70px", marginRight: "190px" }}>
          <ul className="flex justify-between font-bold text-footertextnavyblue text-lg mb-6">
            ...
            <li className="cursor-pointer flex items-center">
              ...
              {/* Check if the dropdown name matches the current state */}
              <div style={{ display: showDropdown === "Manage" ? "block" : "none" }} className="absolute top-full mt-1 left-130 w-48 bg-white border rounded-xl shadow-lg text-base font-semibold">
                <ul>
            ...
            <li className="cursor-pointer flex items-center">
              ...
              <div style={{ display: showDropdown === "Rent" ? "block" : "none" }} className="absolute top-full mt-1 left-130 w-48 bg-white border rounded-xl shadow-lg text-base font-semibold">
                <ul>
                  <li className="p-2 hover:bg-gray-200">Tenancy Information</li>
            ...
            <li className="cursor-pointer flex items-center">
              ...
              <div style={{ display: showDropdown === "Other Services" ? "block" : "none" }} className="absolute top-full mt-1 left-130 w-48 bg-white border rounded-xl shadow-lg text-base font-semibold">
                <ul>
